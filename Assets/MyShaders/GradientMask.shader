...
/// Final Color:
                return fixed4(finalColor,lerp(tex2D(_invisible_shader,TRANSFORM_TEX(node_1177.rg, _invisible_shader)).a,tex2D(_rounded,TRANSFORM_TEX(node_1177.rg, _rounded)).a,_alpha_blend));
            }
            ENDCG
        }
    }
