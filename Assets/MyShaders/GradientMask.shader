...
////// Emissive:
                ...
                float3 emissive = lerp(tex2D(_yellow_asset,TRANSFORM_TEX(node_1161.rg, _yellow_asset)).rgb,tex2D(_organe_asset,TRANSFORM_TEX(node_1161.rg, _organe_asset)).rgb,_Blend);
                float3 finalColor = emissive;
/// Final Color:
                return fixed4(finalColor,tex2D(_roundedCorner,TRANSFORM_TEX(node_1161.rg, _roundedCorner)).a);
            }
            ENDCG
        }
    }
