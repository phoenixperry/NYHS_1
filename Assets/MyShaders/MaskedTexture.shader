...
/////// Diffuse:
                ...
                finalColor += diffuseLight * tex2D(_image,TRANSFORM_TEX(node_29.rg, _image)).rgb;
/// Final Color:
                return fixed4(finalColor,lerp(tex2D(_invisible,TRANSFORM_TEX(node_29.rg, _invisible)).a,tex2D(_visible,TRANSFORM_TEX(node_29.rg, _visible)).a,_alpha_blend));
            }
            ENDCG
        }
        Pass {
...
/////// Diffuse:
                ...
                finalColor += diffuseLight * tex2D(_image,TRANSFORM_TEX(node_30.rg, _image)).rgb;
/// Final Color:
                return fixed4(finalColor * lerp(tex2D(_invisible,TRANSFORM_TEX(node_30.rg, _invisible)).a,tex2D(_visible,TRANSFORM_TEX(node_30.rg, _visible)).a,_alpha_blend),0);
            }
            ENDCG
        }
    }
