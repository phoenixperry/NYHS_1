...
Shader "Shader Forge/Shadow" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _alpah; uniform float4 _alpah_ST;
            struct VertexInput {
...
////// Emissive:
                float2 node_6 = i.uv0;
                float4 node_2 = tex2D(_alpah,TRANSFORM_TEX(node_6.rg, _alpah));
...
/////// Diffuse:
                ...
                float3 diffuseLight = diffuse;
                float2 node_7 = i.uv0;
                float4 node_2 = tex2D(_alpah,TRANSFORM_TEX(node_7.rg, _alpah));
                finalColor += diffuseLight * node_2.rgb;
/// Final Color:
