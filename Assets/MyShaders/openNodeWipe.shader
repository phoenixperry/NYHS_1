...
////// Emissive:
                ...
                float3 emissive = tex2D(_IMAGE,TRANSFORM_TEX(node_79.rg, _IMAGE)).rgb;
                float3 finalColor = emissive;
/// Final Color:
                return fixed4(finalColor,lerp(tex2D(_invisible,TRANSFORM_TEX(node_79.rg, _invisible)).a,tex2D(_visible,TRANSFORM_TEX(node_79.rg, _visible)).a,_node_wipe));
            }
            ENDCG
        }
    }
